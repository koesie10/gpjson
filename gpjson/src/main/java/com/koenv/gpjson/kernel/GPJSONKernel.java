...
public enum GPJSONKernel {
    ...
    FIND_VALUE("find_value", "file: inout pointer char, n: sint64, new_line_index: in pointer sint64, new_line_index_size: sint64, string_index: in pointer sint64, leveled_bitmaps_index: in pointer sint64, leveled_bitmaps_index_size: sint64, level_size: sint64, num_levels: sint32, query: in pointer uint8, result_size: sint32, result: out pointer sint64", "com/koenv/gpjson/kernels/find_value.cu"),
    ...
    USER_LANG_QUERY("user_lang_query", "file: inout pointer char, n: sint64, new_line_index: in pointer sint64, new_line_index_size: sint64, string_index: in pointer sint64, leveled_bitmaps_index: in pointer sint64, leveled_bitmaps_index_size: sint64, level_size: sint64, num_levels: sint32, result: out pointer sint64", "com/koenv/gpjson/kernels/user_lang_query.cu");
