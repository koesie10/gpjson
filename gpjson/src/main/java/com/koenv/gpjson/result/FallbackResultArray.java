...
public class FallbackResultArray implements TruffleObject {
    private final List<List<String>> jsonValues;

    public FallbackResultArray(List<List<String>> jsonValues) {
    ...
    public Object readArrayElement(long index) throws UnsupportedMessageException, InvalidArrayIndexException {
        ...
        return new FallbackResultItem(jsonValues.get((int) index));
    }
