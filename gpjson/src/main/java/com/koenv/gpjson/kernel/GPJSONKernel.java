...
public enum GPJSONKernel {
    ...
    CREATE_LEVELED_BITMAPS_CARRY_INDEX("create_leveled_bitmaps_carry_index", "file: inout pointer char, n: sint64, string_index: inout pointer sint64, level_carry_index: inout pointer sint8, num_levels: uint8", "com/koenv/gpjson/kernels/create_leveled_bitmaps_carry_index.cu"),
    CREATE_LEVELED_BITMAPS("create_leveled_bitmaps", "file: inout pointer char, n: sint64, string_index: inout pointer sint64, carry_index: inout pointer sint8, structural_index: inout pointer sint64, structural_index_size: sint64, level_size: sint64, num_levels: uint8", "com/koenv/gpjson/kernels/create_leveled_bitmaps.cu");
