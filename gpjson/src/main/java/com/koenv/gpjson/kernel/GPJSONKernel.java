...
public enum GPJSONKernel {
    ...
    DISCOVER_STRUCTURE("discover_structure", "file: inout pointer char, n: sint64, string_index: inout pointer sint64, structural_index: inout pointer char", "com/koenv/gpjson/kernels/discover_structure.cu"),
